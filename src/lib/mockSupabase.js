...
let db = {
  ...
  hunting_grounds: [
    ...
    { id: 'gnd-4', user_id: 'demo-u3', name: '十勝平野猟区',   prefecture: '北海道', address: '帯広市以平町', area_ha: 600, terrain: '平地・丘陵', notes: 'エゾシカ多し',   latitude: 42.920, longitude: 143.200, created_at: '2024-09-20T00:00:00Z' },
    { id: 'gnd-5', user_id: 'demo-u3', name: '日高山脈東麓',   prefecture: '北海道', address: '中札内村',     area_ha: 450, terrain: '山岳',       notes: 'ヒグマ注意',     latitude: 42.700, longitude: 143.050, created_at: '2024-10-10T00:00:00Z' },
  ],
  ...
  licenses: [
    ...
    { id: 'lic-5', user_id: 'demo-u1', name: '猟銃等講習会修了証', license_number: '安全-2024-0023', issued_date: '2024-02-15', expiry_date: '2027-02-14', issuer: '北海道公安委員会', notes: '初心者講習', created_at: '2024-02-15T00:00:00Z' },
    { id: 'lic-6', user_id: 'demo-u1', name: '技能講習修了証', license_number: '技能-2023-0456', issued_date: '2023-12-01', expiry_date: '2026-11-30', issuer: '北海道猟友会', notes: '散弾銃・ライフル銃技能講習', created_at: '2023-12-01T00:00:00Z' },
    { id: 'lic-7', user_id: 'demo-u2', name: '猟銃等講習会修了証', license_number: '安全-2023-0078', issued_date: '2023-08-10', expiry_date: '2026-08-09', issuer: '長野県公安委員会', notes: '', created_at: '2023-08-10T00:00:00Z' },
  ],

  permit_books: [
    { id: 'pb-1', user_id: 'demo-u1', book_number: '第030120000001号', original_issue_date: '2020-02-21', issue_date: '2026-02-03', created_at: '2024-01-01T00:00:00Z' },
    { id: 'pb-2', user_id: 'demo-u2', book_number: '第030220000002号', original_issue_date: '2021-06-15', issue_date: '2026-06-20', created_at: '2024-01-01T00:00:00Z' },
  ],

  firearms: [
    { id: 'gun-1', user_id: 'demo-u1', name: 'ブローニングBPS 12番', type: '散弾銃', manufacturer: 'Browning', model: 'BPS', serial_number: 'BPS-123456', caliber: '12番', mechanism: 'ポンプアクション式', original_permit_date: '2020-02-21', original_permit_number: '220020001', permit_date: '2026-01-28', permit_validity_text: '令和11年の誕生日まで', renewal_from: '2028-11-27', renewal_to: '2028-12-27', permit_number: '220060101', notes: 'メインの狩猟銃', created_at: '2024-09-01T00:00:00Z' },
    { id: 'gun-2', user_id: 'demo-u1', name: 'ウィンチェスター M70 .30-06', type: 'ライフル', manufacturer: 'Winchester', model: 'Model 70', serial_number: 'M70-789012', caliber: '.30-06', mechanism: 'ボルトアクション式', original_permit_date: '2020-04-10', original_permit_number: '220020002', permit_date: '2026-04-08', permit_validity_text: '令和11年の誕生日まで', renewal_from: '2029-02-01', renewal_to: '2029-03-01', permit_number: '220060202', notes: '長距離ライフル', created_at: '2024-09-01T00:00:00Z' },
    { id: 'gun-3', user_id: 'demo-u2', name: 'レミントン 870 12番', type: '散弾銃', manufacturer: 'Remington', model: '870', serial_number: 'R870-345678', caliber: '12番', mechanism: 'ポンプアクション式', original_permit_date: '2021-06-15', original_permit_number: '210060001', permit_date: '2026-06-20', permit_validity_text: '令和11年の誕生日まで', renewal_from: '2029-04-01', renewal_to: '2029-05-01', permit_number: '210060201', notes: '', created_at: '2024-10-01T00:00:00Z' },
    { id: 'gun-4', user_id: 'demo-u3', name: 'ウィンチェスター SXP 12番', type: '散弾銃', manufacturer: 'Winchester', model: 'SXP', serial_number: 'SXP-654321', caliber: '12番', mechanism: 'ポンプアクション式', original_permit_date: '2021-03-20', original_permit_number: '210030001', permit_date: '2026-03-18', permit_validity_text: '令和11年の誕生日まで', renewal_from: '2029-01-01', renewal_to: '2029-02-01', permit_number: '210030201', notes: '', created_at: '2024-09-15T00:00:00Z' },
    { id: 'gun-5', user_id: 'demo-u3', name: 'レミントン M700 .30-06', type: 'ライフル', manufacturer: 'Remington', model: 'M700', serial_number: 'M700-112233', caliber: '.30-06', mechanism: 'ボルトアクション式', original_permit_date: '2022-05-10', original_permit_number: '220050001', permit_date: '2026-05-08', permit_validity_text: '令和11年の誕生日まで', renewal_from: '2029-03-01', renewal_to: '2029-04-01', permit_number: '220050201', notes: 'メインの狩猟ライフル', created_at: '2024-09-15T00:00:00Z' },
  ],
