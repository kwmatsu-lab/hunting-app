...
let db = {
  ...
  firearms: [
    { id: 'gun-1', user_id: 'demo-u1', name: 'ブローニングBPS 12番', type: '散弾銃', manufacturer: 'Browning', model: 'BPS', serial_number: 'BPS-123456', caliber: '12番', mechanism: 'ポンプアクション式', original_permit_date: '2020-02-21', original_permit_number: '第220020001号', permit_date: '2026-01-28', permit_validity_text: '令和11年の誕生日まで', renewal_period_text: '令和10年11月27日から令和10年12月27日までの間', permit_number: '札北01-98765', permit_expiry: '2026-08-31', permit_issuer: '北海道警察 札幌北警察署', safe_storage: '専用ロッカー（スチール製）', notes: 'メインの狩猟銃', created_at: '2024-09-01T00:00:00Z' },
    { id: 'gun-2', user_id: 'demo-u1', name: 'ウィンチェスター M70 .30-06', type: 'ライフル', manufacturer: 'Winchester', model: 'Model 70', serial_number: 'M70-789012', caliber: '.30-06', mechanism: 'ボルトアクション式', original_permit_date: '2020-04-10', original_permit_number: '第220020002号', permit_date: '2026-04-08', permit_validity_text: '令和11年の誕生日まで', renewal_period_text: '令和10年2月1日から令和10年3月1日までの間', permit_number: '札北01-88888', permit_expiry: '2027-03-31', permit_issuer: '北海道警察 札幌北警察署', safe_storage: '専用ロッカー（スチール製）', notes: '長距離ライフル', created_at: '2024-09-01T00:00:00Z' },
    { id: 'gun-3', user_id: 'demo-u2', name: 'レミントン 870 12番', type: '散弾銃', manufacturer: 'Remington', model: '870', serial_number: 'R870-345678', caliber: '12番', mechanism: 'ポンプアクション式', original_permit_date: '2021-06-15', original_permit_number: '第210060001号', permit_date: '2026-06-20', permit_validity_text: '令和11年の誕生日まで', renewal_period_text: '令和10年4月から令和10年5月までの間', permit_number: '長野01-22222', permit_expiry: '2028-06-30', permit_issuer: '長野県警察 伊那警察署', safe_storage: '専用ロッカー', notes: '', created_at: '2024-10-01T00:00:00Z' },
    { id: 'gun-4', user_id: 'demo-u3', name: 'ウィンチェスター SXP 12番', type: '散弾銃', manufacturer: 'Winchester', model: 'SXP', serial_number: 'SXP-654321', caliber: '12番', mechanism: 'ポンプアクション式', original_permit_date: '2021-03-20', original_permit_number: '第210030001号', permit_date: '2026-03-18', permit_validity_text: '令和11年の誕生日まで', renewal_period_text: '令和10年1月から令和10年2月までの間', permit_number: '北海01-33333', permit_expiry: '2026-06-30', permit_issuer: '北海道警察 帯広警察署', safe_storage: '専用ロッカー', notes: '', created_at: '2024-09-15T00:00:00Z' },
  ],
